...
export function HowCoreWorks({ image }: { image: MediaSlotValue }) {
      ...
      <div className="container-wide">
        <div className="grid gap-16 lg:grid-cols-[1fr_1.2fr] lg:gap-24">
          <Reveal className="lg:sticky lg:top-28 lg:self-start">
            <span className="eyebrow" data-cms-key="content:howCoreWorks.eyebrow">
              {t('eyebrow')}
            </span>
            <h2 className="mt-6 font-display text-display-xs text-balance tracking-tighter text-fg">
              <span data-cms-key="content:howCoreWorks.title1">
                <RevealText text={t('title1')} />
              </span>{' '}
              <span className="text-muted" data-cms-key="content:howCoreWorks.title2">
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    <h3
                      ...
                      data-cms-key={`content:howCoreWorks.steps.${i}.title`}
                    >
                      {step.title}
                    </h3>
                    <p
                      className="mt-4 max-w-xl text-pretty leading-relaxed text-muted"
                      data-cms-key={`content:howCoreWorks.steps.${i}.desc`}
                    >
                      {step.desc}
                    </p>
                  </div>
